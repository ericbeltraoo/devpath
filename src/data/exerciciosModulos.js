// ---------------------------------------------------------------------------
// EXERCICIOS POR MODULO — 3 niveis cada
// ---------------------------------------------------------------------------
// Regra de construcao, e ela nao e decorativa:
//
//   Nivel 1 — AQUECIMENTO: o assunto do modulo isolado. 20 a 45 min.
//   Nivel 2 — MERCADO: contexto real de empresa. Obriga a reusar 1 a 2 modulos
//             anteriores. E aqui que voce descobre o que esqueceu.
//   Nivel 3 — ENTREVISTA: nivel de teste tecnico real. Puxa 3+ modulos
//             anteriores e cobra decisao de design, nao so sintaxe.
//
// `revisa` lista os modulos que o exercicio OBRIGA a reusar. Nao e sugestao:
// sem eles, o enunciado nao fecha.
// ---------------------------------------------------------------------------
...
export function totaisExercicios() {
  ...
  return { modulos: mods.length, total }
}
